...
@yield('parte_superior') <!-- este yield es para poder agregar este formulario de creación de atenciones en alguna otra vista -->
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="alert alert-success alert-dismissable">
            <a href="{{ route('atenciones.index') }}" class="btn btn-success btn-sm" role="button">Ver Atenciones</a>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('atenciones.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="proximo_turno" type="date" class="form-control @error('proximo_turno') is-invalid @enderror" name="proximo_turno" value="{{ old('proximo_turno') }}" autocomplete="off">
