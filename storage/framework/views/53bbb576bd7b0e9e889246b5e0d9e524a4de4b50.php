...
<div class="container my-4">
    ...
    <div class="alert alert-warning alert-dismissable" role="alert">
        ...
        Paciente eliminado, si desea deshacer haga <a href="<?php echo e(route('pacientes.restore', [Session::get('deleted')])); ?>">Click aquí</a>
    </div>
    <?php endif; ?>
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group-sm dt-col-nowrap" role="group" aria-label="Basic example">
                        <a href="<?php echo e(route('pacientes.show', $paciente)); ?>" class="btn btn-info">Ver</a>
                        <a href="<?php echo e(route('pacientes.edit', $paciente)); ?>" class="btn btn-dark">Editar</a>
