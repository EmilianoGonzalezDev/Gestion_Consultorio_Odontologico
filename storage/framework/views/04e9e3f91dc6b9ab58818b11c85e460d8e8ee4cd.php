    ...
    <div class="container my-4">
        ...
        <?php if(Session::has('deleted')): ?>
            <div class="alert alert-warning alert-dismissable" role="alert">
                ...
                Registro de compra eliminado, si desea deshacer haga <a href="<?php echo e(route('comprainsumos.restore', [Session::get('deleted')])); ?>">Click aquí</a> </div>
        <?php endif; ?>
        ...
        <table id="comprainsumos">
            ...
            <tbody>
                <?php $__currentLoopData = $comprainsumos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  <!-- En cada vuelta, guarda una fila de la tabla CompraInsumos en la variable $compra --> 
                    <?php if($compra->insumo): ?> <!-- ( "Si existe el insumo para esta compra..." ) | evita error al intentar mostrar info sobre insumos eliminados -->
                        <?php
