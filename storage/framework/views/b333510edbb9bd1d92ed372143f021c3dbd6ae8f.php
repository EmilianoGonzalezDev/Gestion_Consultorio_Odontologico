...
<div class="container my-4">
    ...
    <div class="alert alert-warning alert-dismissable" role="alert">
        ...
        Pago eliminado, si desea deshacer haga <a href="<?php echo e(route('atenciones.restaurarPago', [Session::get('deleted')])); ?>">Click aquí</a>
    </div>
    <?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table>
                    <tr>
                        <td><b>Paciente:</b></td>
                        <td> #<?php echo e($paciente->id); ?> - <?php echo e($paciente->nombre); ?> <?php echo e($paciente->apellido); ?></td>
                    </tr>
                    ...
                    <tr>
                        <td><b>Fecha:</b></td>
                        <td> <?php echo e($atencion->fecha->formatLocalized('%d/%m/%Y')); ?> <?php echo e(\Carbon\Carbon::parse($atencion->hora)->formatLocalized('%H:%M')); ?></td>
                    </tr>
                    <tr>
                        <td><b>Arcada superior:</b></td>
                        <td> <?php echo e($atencion->arcada_superior); ?></td>
                    </tr>
                    <tr>
                        <td><b>Arcada inferior:</b></td>
                        <td> <?php echo e($atencion->arcada_inferior); ?></td>
                    </tr>
                    <tr>
                        <td><b>Operación prevista:</b></td>
                        <td> <?php echo e($atencion->operacion_prevista); ?></td>
                    </tr>
                    <tr>
                        <td><b>Importe:</b></td>
                    ...
                    <tr>
                        <td><b>Saldo:</b></td>
                        <td> <b>$<?php echo e($atencion->importe - $atencion->pago); ?></b></td>
                    </tr>
                    <tr>
                        <td><b>Próximo turno:</b></td>
                        <td> <?php if($atencion->proximo_turno): ?> <?php echo e(\Carbon\Carbon::parse($atencion->proximo_turno)->formatLocalized('%d/%m/%Y')); ?> <?php endif; ?></td>
                    </tr>
                </table>
