    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('insumos.update', $insumo->id)); ?>">
...
endif; ?>" name="nombre" value="<?php echo e($insumo->nombre); ?>" required autocomplete="nombre" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="marca" value="<?php echo e($insumo->marca); ?>" required autocomplete="marca" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="contenido_cantidad" value="<?php echo e($insumo->contenido_cantidad); ?>" required autocomplete="contenido_cantidad" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contenido_unidad" type="text" maxlength="4" class="form-control <?php if ($errors->has('contenido_unidad')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('contenido_unidad'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="contenido_unidad" value="<?php echo e($insumo->contenido_unidad); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="detalles" value="<?php echo e($insumo->detalles); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="stock_bajo" type="number" min="0" class="form-control <?php if ($errors->has('stock_bajo')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('stock_bajo'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="stock_bajo" value="<?php echo e($insumo->stock_bajo); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\odonto\resources\views/insumos/editar.blade.php ENDPATH**/ ?>