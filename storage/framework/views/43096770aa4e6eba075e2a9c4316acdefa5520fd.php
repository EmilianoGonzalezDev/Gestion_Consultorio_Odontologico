...
<div class="container my-4">
    ...
    <div class="alert alert-warning alert-dismissable" role="alert">
        ...
        Empleado eliminado, si desea deshacer haga <a href="<?php echo e(route('empleados.restore', [Session::get('deleted')])); ?>">Click aquí</a>
    </div>
    <?php endif; ?>
</div>
...
<div class="div_titulo">
    ...
    <div class="my-4 btn-group-sm">
        <a href="<?php echo e(route('empleados.create')); ?>" class="btn btn-primary">Nuevo Usuario</a>
    </div>
</div>
