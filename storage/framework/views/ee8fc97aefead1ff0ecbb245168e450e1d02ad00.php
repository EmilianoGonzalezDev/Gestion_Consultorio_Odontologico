...
<div class="container my-4">
    ...
    <div class="alert alert-warning alert-dismissable" role="alert">
        ...
        Registro eliminado, si desea deshacer haga <a href="<?php echo e(route('ortodoncias.restore', [Session::get('deleted')])); ?>">Click aquí</a>
    </div>
    <?php endif; ?>
</div>
...
<div class="div_titulo">
    ...
    <div class="my-4  btn-group-sm">
        <a href="<?php echo e(route('ortodoncias.create')); ?>" class="btn btn-primary">Nueva Ficha</a>
    </div>
</div>
...
<div class="div_tabla">
    <table id="ortodoncias" class="table table-hover table-responsive">
        ...
        <tbody>
            <?php $__currentLoopData = $ortodoncias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ortodoncia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <th scope="row">
